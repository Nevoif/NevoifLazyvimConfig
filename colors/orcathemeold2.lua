...
function theme.setup()
  ...
  -- Floating windows (dialogs, panels, chat)
  vim.api.nvim_set_hl(0, "NormalFloat", { bg = "#121620", fg = c.fg })
  vim.api.nvim_set_hl(0, "floatBorder", { bg = "#121620", fg = c.accent, bold = true })
  ...
  vim.api.nvim_set_hl(0, "AvanteTitle", { fg = c.accent, bg = "#121620", bold = true })
  vim.api.nvim_set_hl(0, "AvanteNormal", { bg = "#121620", fg = c.fg })
  vim.api.nvim_set_hl(0, "AvanteBorder", { fg = c.accent, bg = "#121620" })
  
  -- Noice UI enhancements
  vim.api.nvim_set_hl(0, "NoiceCmdlinePopupBorder", { fg = c.accent, bg = "#121620" })
  vim.api.nvim_set_hl(0, "NoiceCmdlinePopup", { bg = "#121620", fg = c.fg })
  vim.api.nvim_set_hl(0, "NoicePopupBorder", { fg = c.accent, bg = "#121620" })
  vim.api.nvim_set_hl(0, "NoiceFormatEvent", { fg = c.yellow, bold = true })
  
  -- Dressing.nvim (dialog boxes)
  vim.api.nvim_set_hl(0, "DressingInputNormal", { bg = "#121620", fg = c.fg })
  vim.api.nvim_set_hl(0, "DressingInputBorder", { fg = c.accent, bg = "#121620" })
  vim.api.nvim_set_hl(0, "DressingSelectNormal", { bg = "#121620", fg = c.fg })
  vim.api.nvim_set_hl(0, "DressingSelectBorder", { fg = c.accent, bg = "#121620" })

  -- Window separators and bars
  vim.api.nvim_set_hl(0, "WinSeparator", { fg = c.grey, bold = false })
  vim.api.nvim_set_hl(0, "WinBar", { fg = c.fg, bg = "#121317" })
  vim.api.nvim_set_hl(0, "WinBarNC", { fg = c.comment, bg = "#0f1419" })

  -- Search and command-line UI
  vim.api.nvim_set_hl(0, "IncSearch", { bg = c.yellow, fg = c.bg, bold = true })
  vim.api.nvim_set_hl(0, "CmdlinePrompt", { fg = c.accent, bold = true })
  vim.api.nvim_set_hl(0, "CmdlineInput", { fg = c.fg, bg = "#121620" })

  -- Fold column
  vim.api.nvim_set_hl(0, "FoldColumn", { fg = c.accent, bg = c.bg })
  vim.api.nvim_set_hl(0, "Folded", { fg = c.comment, bg = "#151a25" })

  -- Trouble.nvim (diagnostics panel)
  vim.api.nvim_set_hl(0, "TroubleNormal", { bg = "#121620", fg = c.fg })
  vim.api.nvim_set_hl(0, "TroubleBorder", { fg = c.accent, bg = "#121620" })

  -- NeoTree floating windows
  vim.api.nvim_set_hl(0, "NeoTreeFloatBorder", { fg = c.accent, bg = "#121620" })
  vim.api.nvim_set_hl(0, "NeoTreeFloatTitle", { fg = c.accent, bg = "#121620", bold = true })

  -- Avante AI message differentiation
  vim.api.nvim_set_hl(0, "AvanteCode", { bg = "#0f1419", fg = "#83F57F" })
  vim.api.nvim_set_hl(0, "AvanteQuestion", { fg = c.lightblue, italic = true })
